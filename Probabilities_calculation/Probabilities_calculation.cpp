...
// Probabilities_calculation.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CProbabilities_calculationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CProbabilities_calculationApp

CProbabilities_calculationApp::CProbabilities_calculationApp()
{
...
// Единственный объект CProbabilities_calculationApp

CProbabilities_calculationApp theApp;


// инициализация CProbabilities_calculationApp

BOOL CProbabilities_calculationApp::InitInstance()
{
	...
	CProbabilities_calculationDlg dlg;
	m_pMainWnd = &dlg;
